...
#SBATCH --output=/data/achahe/alpamayo-recipes/recipes/alpamayo1_5_sft/training/slurm_%j.out
#SBATCH --error=/data/achahe/alpamayo-recipes/recipes/alpamayo1_5_sft/training/slurm_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=1
