...
#SBATCH --output=/data/achahe/alpamayo-recipes/recipes/alpamayo1_5_sft/training/eval_s2_%j.out
#SBATCH --error=/data/achahe/alpamayo-recipes/recipes/alpamayo1_5_sft/training/eval_s2_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=1
