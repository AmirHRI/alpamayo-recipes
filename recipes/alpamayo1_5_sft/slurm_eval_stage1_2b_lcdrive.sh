...
#SBATCH --output=/temp/achahe/alpamayo-recipes/recipes/alpamayo1_5_sft/training/eval_%j.out
#SBATCH --error=/temp/achahe/alpamayo-recipes/recipes/alpamayo1_5_sft/training/eval_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=1
